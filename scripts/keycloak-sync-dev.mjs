...
async function syncJosanzRealmUsers(token, webSpaUuid, figmaSpaUuid, verifactuCrmUuid) {
  const users = [
    ...
    {
      username: 'alexis-administrador',
      email: 'administrador@alexis.local',
      firstName: 'Ana',
      lastName: 'Administradora',
      tenantId: ALEXIS_TENANT_ID,
      clientRoles: { [JOSANZ_CLIENT_ID]: ['admin', 'user'] },
    },
    {
      username: 'alexis-responsable',
      email: 'responsable@alexis.local',
      firstName: 'Rubén',
      lastName: 'Responsable',
      tenantId: ALEXIS_TENANT_ID,
      clientRoles: { [JOSANZ_CLIENT_ID]: ['user'] },
    },
    {
      username: 'alexis-usuario',
