  ...
  template: `
    @if (open) {
      <div class="fixed inset-0 z-50" role="presentation">
        ...
        <div
          class="pointer-events-none fixed inset-0 flex items-end justify-center p-4"
        >
          <section
            class="pointer-events-auto w-full max-w-3xl rounded-t-[32px] border border-solid p-0 shadow-2xl"
