...
const dashboardShellTemplate = `
  <div class="relative mx-auto h-[720px] max-w-[390px] overflow-hidden rounded-[32px] border border-solid" style="background: var(--josanz-bg); border-color: var(--josanz-border);">
    <div class="grid gap-4 p-6 pb-32">
      <div>
        <p class="m-0 text-[10px] font-black uppercase tracking-[0.18em]" style="color: var(--josanz-text-muted);">Hoy</p>
        <h2 class="m-0 mt-1 text-2xl font-black" style="color: var(--josanz-text);">Panel móvil</h2>
      </div>
      <div class="rounded-3xl border border-solid p-5" style="background: var(--josanz-surface); border-color: var(--josanz-border);">
        <p class="m-0 text-sm" style="color: var(--josanz-text-muted);">Eventos activos</p>
        <strong class="mt-2 block text-3xl" style="color: var(--josanz-text);">12</strong>
      </div>
      <div class="rounded-3xl border border-solid p-5" style="background: var(--josanz-surface); border-color: var(--josanz-border);">
        <p class="m-0 text-sm" style="color: var(--josanz-text-muted);">Facturación pendiente</p>
        <strong class="mt-2 block text-2xl" style="color: var(--josanz-text);">24.500 EUR</strong>
      </div>
    </div>
    <josanz-mobile-tab-bar></josanz-mobile-tab-bar>
  </div>
...
export const UseCases: Story = {
  parameters: {
    docs: {
      description: {
        story:
          'Shell móvil con contenido de dashboard para validar separación, contraste y la acción central destacada.',
      },
    },
  },
