...
const meta: Meta<UiBadgeComponent> = {
  ...
  argTypes: {
    color: sbSelect(
      ['default', 'primary', 'success', 'warning', 'danger', 'info', 'purple', 'indigo', 'teal', 'orange', 'pink', 'rose', 'violet', 'fuchsia'] as const,
      'Color',
    ),
    shape: sbSelect(
      ['auto', 'solid', 'glass', 'outline', 'flat', 'neumorphic', 'minimal', 'ghost'] as const,
      'Forma',
    ),
  },
};
