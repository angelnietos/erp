  ...
  template: `
    <div class="min-h-screen" style="background: var(--bg-primary)">
      <header class="dg-app-header sticky top-0 z-50 shadow-md">
        <div
          class="max-w-7xl mx-auto w-full flex flex-wrap justify-between items-center gap-3 px-4 sm:px-6 lg:px-8"
        >
          <a routerLink="/documents/list" class="dg-app-header__brand">
            <span
              class="w-10 h-10 rounded-xl inline-flex items-center justify-center shadow-md shrink-0"
      ...
      <main
        class="doc-gen-main max-w-7xl mx-auto py-6 sm:py-8 px-4 sm:px-6 lg:px-8 pb-28"
      >
        <router-outlet></router-outlet>
      </main>

      <app-theme-selector></app-theme-selector>
      <lib-floating-assistant></lib-floating-assistant>
    </div>
  `,
})
