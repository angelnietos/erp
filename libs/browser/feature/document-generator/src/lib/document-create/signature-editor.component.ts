      ...
      <div class="flex items-center justify-between mb-4">
        <div>
          ...
          <p class="text-xs text-amber-700 mt-0.5">
            Añade bloques de firma al final del documento
          </p>
        </div>
      ...
      @if (config().enabled) {
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div class="lg:sticky lg:top-4 lg:self-start">
            <label class="text-xs font-medium text-amber-700 mb-2 block"
              >Vista previa</label
            >
                  ...
                  <div class="signature-layout-horizontal">
                    <div class="signature-block">
                      ...
                      <div class="signature-name">
                        {{ config().name || 'Nombre del firmante' }}
                      </div>
                      @if (config().title) {
                ...
                @case ('compact') {
                  <div class="signature-layout-compact">
                    <div class="signature-block" style="text-align: left;">
                      ...
                      <div class="signature-name" style="font-size: 0.85rem;">
                        {{ config().name || 'Nombre' }}
                      </div>
                      <div class="signature-title" style="font-size: 0.7rem;">
                        {{ config().title }}
                      </div>
                    </div>
                    <div
                      style="text-align: right; font-size: 0.75rem; color: #9ca3af;"
                    >
                      @if (config().showLocation && config().location) {
