      ...
      <div class="flex items-center justify-between mb-4">
        <div>
          ...
          <p class="text-xs text-slate-500 mt-0.5">
            Personaliza la primera página de tu PDF
          </p>
          <p class="text-xs text-slate-400 mt-1">
            La portada usa su propio fondo y no se verá afectada por el color de
            papel del documento.
          </p>
        </div>
              ...
              <div class="grid grid-cols-2 gap-3">
                ...
                <div class="form-group">
                  ...
                  <select
                    ...
                    (ngModelChange)="
                      update({ markdownSubtitleFontSize: $event })
                    "
                  >
                    <option value="0.95rem">Pequeño</option>
                    <option value="1rem">Medio</option>
          ...
          <div class="lg:sticky lg:top-4 lg:self-start">
            ...
            >
              <div [class]="'cover-layout-' + config().layout">
                ...
                <div class="cover-meta" [style.color]="config().textColor">
