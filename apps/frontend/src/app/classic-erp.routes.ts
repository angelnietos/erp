...
const classicRoutes: Route[] = [
  {
    path: 'dashboard',
    loadChildren: () =>
      import('@josanz-erp/dashboard-feature').then((m) => m.dashboardFeatureRoutes),
    canActivate: [pluginGuard('dashboard'), permissionGuard('dashboard.view')],
  },
  {
    path: 'projects',
    loadChildren: () =>
      import('@josanz-erp/projects-shell').then((m) => m.projectsShellRoutes),
    canActivate: [pluginGuard('projects'), permissionGuard('projects.view')],
  },
  {
    path: 'events',
    loadChildren: () => import('@josanz-erp/events-shell').then((m) => m.eventsShellRoutes),
    canActivate: [pluginGuard('events'), permissionGuard('events.view')],
  },
  {
    path: 'services',
    loadChildren: () =>
      import('@josanz-erp/services-shell').then((m) => m.servicesShellRoutes),
  ...
  {
    path: 'audit',
    loadChildren: () => import('@josanz-erp/audit-shell').then((m) => m.auditShellRoutes),
    canActivate: [pluginGuard('audit'), permissionGuard('audit.view')],
  },
  {
    path: 'receipts',
    loadChildren: () =>
      import('@josanz-erp/receipts-feature').then((m) => m.receiptsFeatureRoutes),
    canActivate: [pluginGuard('receipts'), permissionGuard('receipts.view')],
  },
  {
    path: 'budgets',
  ...
  },
  {
    path: 'inventory',
    loadChildren: () =>
      import('@josanz-erp/inventory-shell').then((m) => m.inventoryShellRoutes),
    canActivate: [pluginGuard('inventory'), permissionGuard('products.view')],
  },
  {
    path: 'delivery',
    loadChildren: () =>
  ...
  {
    path: 'users',
    loadChildren: () => import('@josanz-erp/identity-shell').then((m) => m.usersRoutes),
  ...
  },
  {
    ...
    canActivate: [pluginGuard('ai-insights'), permissionGuard('ai.view')],
  },
  {
    path: 'not-found',
