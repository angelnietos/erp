                  ...
                  <div class="flex flex-wrap items-start justify-between gap-3">
                    <div>
                      ...
                      <p class="text-sm text-secondary mt-1 max-w-2xl">
                        Describe objetivos, póblico y datos clave; la IA genera
...
<textarea
                       ...
                       rows="2"
                       placeholder="Ej.: Acorta a una pógina, tono mós formal, aóade sección de riesgos y mitigación."
                    ...
                    @if (pdfStyles.length > 0) {
                      <div class="document-css-panel">
                        ...
                        <div class="mt-3">
                          ...
                          <p class="text-xs text-muted mt-2">Selecciona cómo se renderizaró el fondo del PDF.</p>
                      ...
                      @if (!fullscreenMode) {
                        <div class="document-editor-split">
                            ...
                            <div class="sidebar-format-grid">
                              ...
                              <button class="sidebar-format-btn" type="button" (click)="insertMarkdown('# ','')" title="Tótulo H1">
                                <span style="font-size:11px;font-weight:800">H1</span>
                                <span>Tót.</span>
                              </button>
                              <button class="sidebar-format-btn" type="button" (click)="insertMarkdown('## ','')" title="Subtótulo H2">
...
<div class="sidebar-divider"></div>
                            ...
                            <div style="padding:0 0.5rem 0.4rem">
                              <div style="display:flex;align-items:center;gap:6px">
                                ...
                                <div style="flex:1;text-align:center;font-size:0.65rem;color:#94a3b8">Tamaóo base</div>
                                <button type="button" style="width:28px;height:28px;border-radius:6px;border:1px solid #e2e8f0;background:#fff;font-size:0.7rem;cursor:pointer" (click)="adjustBaseFontSize(0.05)">A+</button>
                              </div>
                            </div>
                          ...
                          <div class="document-editor-column document-editor-column--preview">
                            <div class="document-editor-column__bar">
                              ...
                              <span class="font-mono">{{ wordCount }} palabras ó {{ characterCount }} caracteres</span>
                            </div>
                        ...
                        <div class="document-fullscreen-body">
                          ...
                          @if (fullscreenTab === 'preview') {
                            <div class="document-editor-column fullscreen-preview">
                              <div class="document-editor-column__bar">
                                Vista Previa
                                <span class="ml-auto text-xs font-mono bg-tertiary px-2 py-0.5 rounded">{{ wordCount }} palabras ó {{ characterCount }} caracteres</span>
                              </div>
                              @if (contentEditorMode === 'html') {
                                <iframe
                                  title="Vista previa HTML"
                ...
                <div class="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                  <div>
                    <h2 class="text-base font-bold text-slate-800">
                      ...
                      @else if (showHeaderFooterEditor) { Encabezado y Pie de Pógina }
                      @else if (showTableBuilder) { Constructor de Tablas }
                      @else if (showImageInsert) { Insertar Imagen }
                    </h2>
                    <p class="text-xs text-slate-500 mt-0.5">
                      @if (showCoverEditor) { Personaliza la primera pógina de tu PDF con logo, tótulos y fondos }
                      @else if (showSignatureEditor) { Configura firmas para los responsables al final del documento }
                      @else if (showHeaderFooterEditor) { Define la paginación y cabeceras de cada pógina }
                      @else if (showTableBuilder) { Diseóa y estructura tablas de datos visualmente }
                      @else if (showImageInsert) { Sube y edita el diseóo de imógenes en tu documento }
                    </p>
                  </div>
