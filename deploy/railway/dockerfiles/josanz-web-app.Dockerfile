...
ENV PORT=80
# URL del servicio backend en Railway (red privada o pública). Ej: http://backend.railway.internal:3000
# El fallback evita que Nginx falle al arrancar si Railway aún no tiene configurado el backend.
